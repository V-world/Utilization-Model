...
function getIndvdLandPriceAttr(pnu) {
	$.ajax({
		...
		success: function (dataS){
			$("#Tab3 table tbody").append("<tr><td>2022</td><td>"+dataS.indvdLandPrices.field[0].pblntfDe+"</td><td>"+numberWithCommas(dataS.indvdLandPrices.field[0].pblntfPclnd)+"</td><td>"+dataS.indvdLandPrices.field[0].stdLandAt+"</td></tr>");
		},
		complete: function (){
			$.ajax({
				url: "https://apis.data.go.kr/1611000/nsdi/IndvdLandPriceService/attr/getIndvdLandPriceAttr?",
